/**
 *
 * @file This file contains the DynamicArray container.
 *
...
#ifndef CCC_DYNAMIC_ARRAY_H_
#define CCC_DYNAMIC_ARRAY_H_
...
struct DynamicArray
{
    ...
    reference at(size_type Index)
    {
        if (Index >= m_Capacity)
        {
            throw std::out_of_range("DynamicArray::at"), m_Array[0];
        }
        return m_Array[Index];
    }
    ...
    {
        return Index < m_Capacity ? m_Array[Index] : (throw std::out_of_range("DynamicArray::at"), m_Array[0]);
    }

...
struct Array
{
    ...
    value_type m_Array[Capacity ? Capacity : 1]; // support zero-sized arrays (see std::array in gcc)
    ...
    {
        return Index < Capacity ? m_Array[Index] : (throw std::out_of_range("ConsistentArray::at"), m_Array[0]);
    }

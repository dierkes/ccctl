...
typedef ::testing::Types<
        ...
        // using raw memory operations:
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 2, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 4, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 8, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 16, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<2, 2>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<2, 2> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<4, 4>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<4, 4> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<8, 8>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<8, 8> > >,
#if !(defined _MSC_VER && defined CCC_X86)
        RefPair<ccc::PodVector<ccc_test::Pod<16, 16>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<16, 16> > >,
#endif
        RefPair<ccc::PodVector<ccc_test::Pod<2, 1>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<2, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<4, 1>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<4, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<8, 1>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<8, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<16, 1>, uint8_t, 10, 1, true>, std::vector<ccc_test::Pod<16, 1> > >,
        // using uninitialized storage:
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 2, false, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 4, false, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 8, false, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<1, 1>, uint8_t, 10, 16, false, true>, std::vector<ccc_test::Pod<1, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<2, 2>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<2, 2> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<4, 4>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<4, 4> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<8, 8>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<8, 8> > >,
#if !(defined _MSC_VER && defined CCC_X86)
        RefPair<ccc::PodVector<ccc_test::Pod<16, 16>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<16, 16> > >,
#endif
        RefPair<ccc::PodVector<ccc_test::Pod<2, 1>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<2, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<4, 1>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<4, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<8, 1>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<8, 1> > >,
        RefPair<ccc::PodVector<ccc_test::Pod<16, 1>, uint8_t, 10, 1, false, true>, std::vector<ccc_test::Pod<16, 1> > >
> RefPairTypes;
